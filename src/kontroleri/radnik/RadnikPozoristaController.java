...
public class RadnikPozoristaController implements Initializable{
	...
	public void predstaveScena(ActionEvent event) throws IOException {
		FXMLLoader RadnikLoader = new FXMLLoader(getClass().getResource("/pogled/RadnikPozorista.fxml"));		
	...
	public void osobljeScena(ActionEvent event) throws IOException {
		FXMLLoader OsobljeLoader = new FXMLLoader(getClass().getResource("/pogled/radnik/RadnikOsoblje.fxml"));		
		root = OsobljeLoader.load();
		
		//RadnikOsobljeController rpc = OsobljeLoader.getController();
		//rpc.initRadnik();
	...
	public void rezervacijeScena(ActionEvent event) throws IOException {
		FXMLLoader RezervacijeLoader = new FXMLLoader(getClass().getResource("/pogled/radnik/RadnikOsoblje.fxml"));		
		root = RezervacijeLoader.load();
